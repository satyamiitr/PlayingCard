...
class PlayingCardView: UIView
{
    ...
    var faceCardScale: CGFloat = SizeRatio.faceCardOfImageSizeToBoundSize
    {
        didSet
        {
            setNeedsDisplay()
    ...
    override func draw(_ rect: CGRect)
    {
        ...
        if isFaceUp
        {
            if rank > 10
            {
                ...
                UIImage(named: "king", in: Bundle(for: self.classForCoder), compatibleWith: traitCollection)?
        ...
        {
            if let backImage = UIImage(named: "backimage")
            {
...
extension PlayingCardView{
    private struct SizeRatio
    {
        ...
        static let faceCardOfImageSizeToBoundSize : CGFloat = 0.5
    }
